...
public class CentralSurfacesGoogle extends CentralSurfacesImpl {
    ...
    public CentralSurfacesGoogle(
        ...
        super(context, notificationsController, fragmentService, lightBarController,
                ...
                flashlightController, configurationController, notificationShadeWindowController, notificationShadeWindowViewControllerLazy, 
                ...
                burnInProtectionController,tunerService, sysUiState);
        mContext = context;
